(() => {
  ...
  function verifyBoundingBoxes() {
    ...
    try {
      ...
      const checks = [
        { sel: '.stripe', figma: { x: 0, y: 0, w: 1333, h: 8 }, name: 'Stripe 442:131' },
        { sel: '.studio-row', figma: { x: 112, y: 100, w: 1109, h: 24 }, name: 'Studio Row 442:124' },
        { sel: '.headline-logo', figma: { x: 112, y: 196, w: 1109, h: 122 }, name: 'Headline & Logo 442:119' },
        { sel: '.follow', figma: { x: 112, y: 382, w: 710, h: 352 }, name: 'Follow Us 442:94' },
        { sel: '.social', figma: { x: 112, y: 500, w: 565, h: 234 }, name: 'Social Media 442:98' }, // measured as its own block, though positioned relative
        { sel: '.hero-figure', figma: { x: 685, y: 350, w: 576, h: 576 }, name: 'Hero Figure 442:92' },
        { sel: '.created-by', figma: { x: 112, y: 902, w: 254, h: 24 }, name: 'Created by 442:88' }
      ];
  ...
  // PUBLIC_INTERFACE
  window.verifyNoteScreen442_87 = verifyBoundingBoxes;
