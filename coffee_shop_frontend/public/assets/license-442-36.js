(() => {
  ...
  function verifyBoundingBoxes() {
    ...
    try {
      ...
      const checks = [
        { sel: '.stripe', figma: { x: 0, y: 0, w: 1333, h: 8 }, name: 'Stripe 442:86' },
        { sel: '.studio-row', figma: { x: 112, y: 100, w: 1109, h: 24 }, name: 'Studio Row 442:79' },
        { sel: '.headline-logo', figma: { x: 112, y: 196, w: 1109, h: 95 }, name: 'Headline & Logo 442:74' },
        { sel: '.detail-agreement', figma: { x: 112, y: 355, w: 750, h: 384 }, name: 'Detail Agreement 442:43' },
        { sel: '.hero-figure', figma: { x: 693, y: 350, w: 576, h: 576 }, name: 'Hero Figure 442:41' },
        { sel: '.created-by', figma: { x: 112, y: 902, w: 254, h: 24 }, name: 'Created by 442:37' }
      ];
      ...
      for (const c of checks) {
        ...
        // Remove page offset by measuring relative to artboard
  ...
  window.verifyLicenseScreen = verifyBoundingBoxes;
